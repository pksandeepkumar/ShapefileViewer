 ...
 */
public class DatabasesSecondary extends SQLiteOpenHelper {

	Context context;
	private static final String TAG = DatabasesSecondary.class.getName();
	public static final String DATABASE_NAME = "DB_Secondary.db";
	public static final int DATABASE_VERSION = 1;

	private static ArrayList<String> query_create_tables = null;
	private static ArrayList<String> tables = null;

	public DatabasesSecondary(Context context) {
